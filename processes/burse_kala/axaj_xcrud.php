...
$xcrud->columns('id, name_kala, moshakhasat, hajm_ghabel_arzeh, baste_bandi, tolid_konnande, makan_tahvil, arz, tasfiyeh, tarikh_tahvil, min_arzeh, min_kharid, max_afzayesh_arzeh');
...
$xcrud->button(
    "javascript:edit_record('{id}', '{name_kala}', '{moshakhasat}', '{hajm_ghabel_arzeh}', '{baste_bandi}', '{tolid_konnande}', '{makan_tahvil}', '{arz}', '{tasfiyeh}', '{tarikh_tahvil}', '{min_arzeh}', '{min_kharid}', '{max_afzayesh_arzeh}', '{file}', '{file_name}');",
    'Edit',
